...
| --- | --- | --- |
| Nom et mot de passe de **LFC-Salon** | Connexion directe de secours | **Appareils → Salon → Accès de secours**, sur cet ordinateur, même hors ligne |
...
À la fin de l’installation, choisissez **Découvrir le Studio**. La visite guidée comprend neuf étapes : accueil, appareils, bibliothèque, éditeur, timeline, diffusion, planning, réglages et retour à vos appareils.

Vous manipulez des exemples en **mode démonstration**. Les appareils réels ne reçoivent aucune commande pendant cette visite. Avancez à votre rythme, revenez en arrière, réduisez le guide pour explorer ou quittez à tout moment. À la sortie, vous retrouvez vos appareils et vos créations.

Pour recommencer : **Réglages → Découvrir le Studio**.

## 5. Envoyer votre première image

1. Sortez de la démo avec **Revenir à mes appareils**.
2. Ouvrez **Contenus**, cliquez **Importer** et choisissez une image.
3. Sélectionnez-la et regardez son aperçu sur votre Tube.
4. Cliquez **Diffuser**, choisissez l’appareil et validez les étapes.
5. Attendez la fin de la préparation et du transfert, puis regardez le résultat sur le Tube.

Vous pourrez ensuite créer des compositions, importer des vidéos et organiser un planning. Le [guide complet](GUIDE-UTILISATEUR.md) détaille ces fonctions.

## Retrouver un appareil hors ligne

Ouvrez **Appareils**, sélectionnez le Tube puis **Accès de secours**. Son nom Wi-Fi et le dernier mot de passe mémorisé restent consultables. Le bouton en forme d’œil révèle le mot de passe.

Rejoignez ce réseau depuis le menu Wi-Fi de l’ordinateur. Une fois le Tube joignable, vous pouvez modifier son accès de secours ou lui donner un nouveau réseau habituel.

Ces identifiants sont conservés sur **le compte utilisateur de cet ordinateur**. Ils ne sont pas inclus dans les projets ou sauvegardes exportés. Si vous changez d’ordinateur, conservez-les dans votre gestionnaire de mots de passe avant de quitter l’ancien poste.

## Besoin d’aide ?

Dans **Réglages → Nous écrire**, indiquez la version du Studio, votre système et le message rencontré. Vous pouvez aussi utiliser la [page d’assistance](https://github.com/WITH-BY/lfc-studio-releases/issues) ; un compte GitHub est nécessaire pour y écrire. Ne joignez pas de mot de passe à votre demande.
